                ...
                <div class="module form-module">
                    ...
                    <div class="form">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="submit"  class="btn theme-btn" name="submit" value="Login" />
                        </form>
                    </div>

                    <div class="cta">Not registered?<a href="registration.php" style="color:#124076;"> Create an account</a></div>
                </div>
