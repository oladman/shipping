...
?>
                ...
                <head>
                    ...
                    <title>All Shipping Updates</title>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All Shipping</h4>
                                                </div>
    ...
    while ($rows = mysqli_fetch_array($query)) {
        ...
        echo '<tr>
                                                                    <td></td>
																								...
																								<td>' . $rows['s_tracking'] . '</td>
																								<td>' . $rows['ss_date'] . '</td>
																								<td>' . $rows['ss_time'] . '</td>



																								<td>' . $rows['ss_location'] . '</td>
																								<td>' . $rows['ss_comment'] . '</td>
                                                                                                <td>' . $rows['ss_status'] . '</td>


																									 <td><a href="delete_shipping_update.php?shipping_del=' . $rows['ss_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
																									 <a href="update_ship_status.php?shipping_upd=' . $rows['ss_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
    }
}
