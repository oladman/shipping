                                            ...
                                            <?php if (!empty($users)) { ?>
                                                <?php foreach ($users as $user) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="update_users.php?user_upd=<?php echo $user['u_id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="delete_users.php?user_del=<?php echo $user['u_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } else { ?>
